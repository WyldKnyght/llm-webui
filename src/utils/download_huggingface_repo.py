            ...
            try:
                ...
                for link, link_file_size in zip(links, link_file_size_list):
                    ...
                    if model_file_name.find("Pooling")>=0:
                        model_file_name = f"{model_file_name}/config.json"
